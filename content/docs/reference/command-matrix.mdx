...
Reference: [copy](/docs/reference/copy). As of `sb-mig@6.5.0-beta.9`. `copy space --only` accepts `languages`, `settings`, `groups`, `components`, `presets`, `datasources`.
...
| `sb-mig copy stories --source <story> --destination <folder>` | `--source` | `--from`, `--to`, `--destination`, `--mode`, `--with-assets`, `--publicationMode`, `--publicationLanguages`, `--fresh`, `--manifestRoot`, `--dry-run`, `--yes`, `--outputPath` | Yes unless `--dry-run` |
...
| `sb-mig copy relink --source <story-or-folder> --destination <folder>` | `--source` | `--from`, `--to`, `--destination`, `--mode`, `--manifestRoot`, `--dry-run`, `--yes`, `--outputPath` | Yes unless `--dry-run`; reference values only |
| `sb-mig copy relink --source / --destination /` | `--source /` | same as above plus `--exclude` | Yes unless `--dry-run`; reference values only, whole space |
| `sb-mig copy assets --all` | `--all` | `--from`, `--to`, `--manifestRoot`, `--dry-run`, `--outputPath` | Yes unless `--dry-run` |
| `sb-mig copy assets --asset <id-url-or-file>` | `--asset` (repeatable) | `--from`, `--to`, `--manifestRoot`, `--dry-run`, `--outputPath` | Yes unless `--dry-run` |
| `sb-mig copy assets --assetFolder <id-or-path>` | `--assetFolder` (repeatable) | `--from`, `--to`, `--manifestRoot`, `--dry-run`, `--outputPath` | Yes unless `--dry-run` |
| `sb-mig copy assets --referenced-by-stories --source <story-or-folder>` | `--referenced-by-stories`, `--source` | `--from`, `--to`, `--mode`, `--manifestRoot`, `--dry-run`, `--outputPath` | Yes unless `--dry-run` |
