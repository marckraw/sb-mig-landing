...
referenced-asset plans log story scan progress and a reference planning summary
so long dry-runs do not appear idle while the graph is being built. With
