...
| `inspect` | Inspect Storyblok content with local query files. ![Beta: Needle in a haystack](https://img.shields.io/badge/Beta-Needle%20in%20a%20haystack-f59e0b) | [inspection commands](/docs/reference/inspection) |
...
| Label | Meaning |
| --- | --- |
| ![Beta: Needle in a haystack](https://img.shields.io/badge/Beta-Needle%20in%20a%20haystack-f59e0b) | A read-only beta inspection feature for finding rare Storyblok component patterns across many stories. |
