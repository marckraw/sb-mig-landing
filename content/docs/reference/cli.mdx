...
| `copy` | Copy a space's schema, stories, folders and assets between spaces with a resumable ledger. | [copy](/docs/reference/copy) |
...
- `migrate continue`
- `revert content`
- `copy stories`, `copy relink`, `copy space` (the confirmation after the PLAN block)
- `copy manifests --prune`
